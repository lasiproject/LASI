...
namespace L_CoreTests
{
    ...
    /// <summary>
    ///This is a test class for PossessiveEndingTest and is intended
    ///to contain all PossessiveEndingTest Unit Tests
    ///</summary>
    [TestClass()]
    public class PossessiveEndingTest
    {
        ...
        public void PossessesForTest() {
            ...
            PossessiveEnding target = new PossessiveEnding(text); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for PossessiveEnding Constructor
        ///</summary>
        [TestMethod()]
        public void PossessiveEndingConstructorTest() {
            string text = string.Empty; // TODO: Initialize to an appropriate value
            PossessiveEnding target = new PossessiveEnding(text);
