    ...
    $(function () {
        ...
        $(document).on('change', '.btn-file :file', function () {
            ...
            $(files)
                ...
                .forEach((file, index) => {
                    $uploadList.append('<div class="list-group-item text-left">' +
                        '<span class="glyphicon glyphicon-remove remove-file"/>&nbsp;&nbsp;&nbsp;<span class="file-index">' + (fileCount + index + 1) +
                        '</span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="file-name">' + (<any>file).name + '</span></div>');
