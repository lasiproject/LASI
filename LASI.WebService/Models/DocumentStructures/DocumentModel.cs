...
namespace LASI.WebService.Models.DocumentStructures
{
    public class DocumentModel : TextualModel<Document, DocumentSetModel>
    {
        public DocumentModel(
            Document document,
            IEnumerable<(string, float)> chartItems,
            string documentId,
        ...
        public DocumentModel(Document document, IEnumerable<(string, float)> chartItems, string documentId) : base(document)
        {
        ...
        public IEnumerable<(string, float)> ChartData { get; }
