...
namespace LASI.Algorithm
{
    ...
    /// Along with the other interfaces in the Syntactic Interfaces Library, the IDirectObjectTaker interface provides for generalization and abstraction over Word and Phrase types.
    /// </summary>
