...
namespace LASI.Algorithm.PhraseTypes
{
    class GerundVerbPhrase : VerbPhrase, IEntity
    {
        ...
        //public static GerundVerbPhrase PromoteVerbPhrase(ref VerbPhrase verbPhrase) {
        //    if (verbPhrase as GerundVerbPhrase != null)
        //        return verbPhrase as GerundVerbPhrase;
        //    else {
        //        verbPhrase = new GerundVerbPhrase(verbPhrase.Words) {
        //            ObjectViaPreposition = verbPhrase.ObjectViaPreposition,
        //            NextPhrase = verbPhrase.NextPhrase,
        //            PreviousPhrase = verbPhrase.PreviousPhrase,
        //            DirectObject = verbPhrase.DirectObject,
        //            IndirectObject = verbPhrase.IndirectObject,
