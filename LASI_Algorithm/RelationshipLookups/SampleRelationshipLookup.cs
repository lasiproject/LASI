...
{
    using EntityPair = LASI.Algorithm.RelationshipLookups.EntityPair<IEntity>;
    ...
    public class SampleRelationshipLookup : IRelationshipLookup<IEntity, IVerbal>
    {
        ...
        public SampleRelationshipLookup(IEnumerable<DocumentConstructs.Sentence> domain)
        ...
        public SampleRelationshipLookup(IEnumerable<DocumentConstructs.Paragraph> domain)
        ...
        public SampleRelationshipLookup(DocumentConstructs.Document domain)
