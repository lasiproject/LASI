...
{
    /// <summary>
    /// Represents entity quantifier verb which specifies the quanitity of an IQuantifiable construct.
    /// </summary>
    public class Quantifier : Word, IQuantifier
    {
        /// <summary>
        /// Represents entity quantifier which specifies the value, count, or degree, of some IQuantifiabe such as entity GenericSingularNoun
        /// </summary>
