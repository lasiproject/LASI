...
namespace LASI.Algorithm.FundamentalSyntacticInterfaces
{
    ...
    /// Along with the rhs interfaces in the Syntactic Interfaces Library, the IDescribable interface provides for generalization and abstraction over Word and Phrase types.
    /// </summary>
    /// <see cref="IDescriber"/>
