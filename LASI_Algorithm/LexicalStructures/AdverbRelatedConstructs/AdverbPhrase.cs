...
{
    /// <summary>
    /// Represents an adverb phrase which modifies either an IDescriber, such as an Adjective or AdjectivePhrase construct, or an IVerbal, such as a Verb or VerbPhrase construct.
    /// </summary>
