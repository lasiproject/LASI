...
{
    /// <summary>
    /// Represents an adverb which 'absolutely' specifies entity verb or adjective relative to all comparable occurances of that verb or adjective.
    /// For Verbs - 
    /// If modifying an instransitive verb it will usually lexically follow the the verb: e.g. "Jane performed BEST.
    /// If modifying entity transitive verb it will usually lexically follow the verb object: e.g. "Jane played poker BEST.
    /// For Adjectives - 
    ...
    {
        /// <summary>
        /// Initializes entity new instance of the SuperlativeAdverb class.
        /// </summary>
