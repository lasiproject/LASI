(function () {
    ...
    test("flatMap test3",
         function () {
             ...
             var expected = [18 * 18, 67 * 67, 18 * 18, 67 * 67];
             deepEqual(actual, expected, ("expected: " + expected + ";  actual: " + actual));
         });
    ...
    test("correlate defined test",
       function () {
           ok(Array.prototype.hasOwnProperty("correlate"), "correlate defined on Array.prototype!");
       });
    test('correlate test 1',
        function () {
            var outer = [9, 2, 3, 4];
            var inner = [16, 95, 71, 81];
            var actual = outer.correlate(inner, function (e) { return e % 2; }, function (e) { return e % 2; });
            var expected = [
                { first: 9, second: 95 },
                { first: 9, second: 71 },
                { first: 9, second: 81 },
    ...
    test('correlate test 3',
        function () {
            var outer = [9, 2, 3, 4];
            var inner = [16, 95, 71, 81];
            var actual = outer.correlate(inner, function (e) { return e % 2; }, function (e) { return e % 2; }, function (o, i) { return o * i; });
            var expected = [9 * 95, 9 * 71, 9 * 81, 2 * 16, 3 * 95, 3 * 71, 3 * 81, 4 * 16];
            notStrictEqual(actual, expected, "expected: " + expected + ";  actual: " + actual);
        });
    test('correlate test 4',
        function () {
            var outer = [9, 2, 3, 4];
            var inner = [16, 95, 71, 81];
            var actual = outer.correlate(inner, function (e) { return e % 2; }, function (e) { return e % 2; }, function (o, i) { return o.toString() + i.toString(); });
            var expected = ["995", "971", "981", "216", "395", "371", "381", "416"];
            deepEqual(actual, expected, "expected: " + expected + ";  actual: " + actual);
        });
