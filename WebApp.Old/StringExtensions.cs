...
namespace LASI.WebApp.Old
{
    public static class StringExtensions
    {
        ...
        public static string ToSafeHtmlDomId(this string value) =>
            string.Join("", value.Select(c => tokenMap.GetValueOrDefault(c, c.ToString())));
        ...
        public static int CreateUniqueId() => idGenerator = System.Threading.Interlocked.Increment(ref idGenerator);
