...
namespace LASI.WebApp.Old.Controllers
{
    ...
    public class DefaultAccountController : Controller
    {
        //
        ...
        private IEnumerable<string> GetErrorsFromModelState() => ModelState.SelectMany(x => x.Value.Errors.Select(error => error.ErrorMessage));
