...
(function () {
    'use strict';
    var test = QUnit.test, deepEqual = QUnit.deepEqual, notStrictEqual = QUnit.notStrictEqual, ok = QUnit.ok, dataGenerator = (function (rand) {
        return {
    ...
    test('flatMap test', function () {
        var actual = [[1, 2, 3], [4, 5, 6], [7, 8]].flatMap(), expected = [1, 2, 3, 4, 5, 6, 7, 8];
        deepEqual(actual, expected, ('expected: ' + expected + ';  actual: ' + actual));
    });
    test('flatMap test1', function () {
        var actual = [[1, 2, 3], [4, 5, 6], [7, 8]].flatMap(undefined, function (x) { return x * x; }), expected = [1, 4, 9, 16, 25, 36, 49, 64];
        deepEqual(actual, expected, ('expected: ' + expected + '  actual: ' + actual));
    });
    test('flatMap test2', function () {
        var actual = [[1, 2, 3], [4, 5, 6], [7, 8]].flatMap(function (e) {
            ...
            return result;
        }, function (x) { return x * x; }), expected = [1, 4, 9, 16, 25, 36, 49, 64];
        deepEqual(actual, expected, ('expected: ' + expected + ';  actual: ' + actual));
    });
    test('flatMap test3', function () {
        ...
        var actual = [
            ...
            return result;
        }, function (x) { return x * x; }), expected = [18 * 18, 67 * 67, 18 * 18, 67 * 67];
        deepEqual(actual, expected, ('expected: ' + expected + ';  actual: ' + actual));
    });
    ...
    test('correlate test 1', function () {
        var outer = [9, 2, 3, 4], inner = [16, 95, 71, 81], actual = outer.correlate(inner, function (e) { return e % 2; }, function (e) { return e % 2; }), expected = [
            { first: 9, second: 95 },
            { first: 9, second: 71 },
            { first: 9, second: 81 },
            { first: 2, second: 16 },
        ...
        deepEqual(actual.map(function (e) { return e.toString(); }), expected.map(function (e) {
            return e.toString();
        }), 'expected: ' + expected + '  actual: ' + actual);
    });
    test('correlate test 2', function () {
        var outer = [9, 2, 3, 4], inner = [16, 95, 71, 81], actual = outer.correlate(inner, function (e) { return e % 2; }, function (e) {
            return e % 2;
        }), expected = [
            { first: 9, second: 95 },
            { first: 9, second: 71 },
        ...
        notStrictEqual(actual.map(function (e) { return JSON.stringify(e); }), expected.map(function (e) {
            return JSON.stringify(e);
        }));
    });
    test('correlate test 3', function () {
        var outer = [9, 2, 3, 4], inner = [16, 95, 71, 81], actual = outer.correlate(inner, function (e) { return e % 2; }, function (e) { return e % 2; }, function (o, i) {
            return o * i;
    ...
    test('correlate test 4', function () {
        var outer = [9, 2, 3, 4], inner = [16, 95, 71, 81], actual = outer.correlate(inner, function (e) {
            return e % 2;
        }, function (e) {
            return e % 2;
        }, function (o, i) {
    ...
    test('average test1', function () {
        var numbers = dataGenerator.randomNumberRange(10), actual = numbers.average(function (x) { return x; }), expected = numbers.reduce(function (sum, x) { return sum + x; }, 0) / numbers.length;
        deepEqual(actual, expected, ('expected: ' + expected + ';  actual: ' + actual));
    });
}());
