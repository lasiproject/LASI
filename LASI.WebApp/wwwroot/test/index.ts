...
export function runTests() {
    ...
    test('flatMap test1', function () {
        var actual = [[1, 2, 3], [4, 5, 6], [7, 8]].flatMap(undefined, function (x: number) { return x * x; }),
    ...
    test('correlate test 2', function () {
        var outer = [9, 2, 3, 4],
            inner = [16, 95, 71, 81],
            actual = outer.correlate(inner, function (e) { return e % 2; }, function (e) {
                return e % 2;
            }),
            expected = [
                { first: 9, second: 95 },
    ...
    test('correlate test 3', function () {
        var outer = [9, 2, 3, 4],
            inner = [16, 95, 71, 81],
            actual = outer.correlate(inner, function (e) { return e % 2; }, function (e) { return e % 2; }, function (o, i) {
                return o * i;
            }),
    ...
    test('correlate test 4', function () {
        var outer = [9, 2, 3, 4],
            inner = [16, 95, 71, 81],
            actual = outer.correlate(inner, function (e) {
                return e % 2;
            }, function (e) {
                return e % 2;
            }, function (o, i) {
