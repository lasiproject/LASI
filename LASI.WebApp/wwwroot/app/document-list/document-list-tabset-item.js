...
'use strict';
System.register(['app/document-list/document-list-tabset-item.html'], function(exports_1) {
    var document_list_tabset_item_html_1;
    function documentListTabsetItem(resultsService) {
        return {
            template: document_list_tabset_item_html_1.default,
            restrict: 'E',
    ...
    return {
        setters:[
            function (document_list_tabset_item_html_1_1) {
                document_list_tabset_item_html_1 = document_list_tabset_item_html_1_1;
            }],
        execute: function() {
