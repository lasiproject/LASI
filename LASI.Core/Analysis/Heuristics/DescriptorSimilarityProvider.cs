...
namespace LASI.Core
{
    public static partial class Lexicon
    {
        ...
        /// </returns>
        public static Similarity IsSimilarTo(this Adjective first, Adjective second) => Similarity.FromBoolean(first.IsSynonymFor(second));
        ...
        /// otherwise, <c>false</c>.
        /// </returns>
        public static Similarity IsSimilarTo(this Adjective first, AdjectivePhrase second) => Similarity.FromBoolean(second.Words.OfAdjective().Any(a => a.IsSynonymFor(first)));
        ...
        public static Similarity IsSimilarTo(this AdjectivePhrase first, AdjectivePhrase second) =>
            Similarity.FromRatio(first.Words.OfAdjective().Zip(second.Words.OfAdjective(), (a, b) => a.IsSynonymFor(b)).PercentTrue() / 100);
    }
}