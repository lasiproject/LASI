...
namespace LASI.Core.Heuristics.Relationships
{
    ...
    {
        IEnumerable<TVerbal> VerbalRelationshipDomain { get; }
        ...
        IEnumerable<TVerbal> this[TEntity actionPerformer, TEntity actionReceiver] { get; }
        /// <summary>
        /// Gets the Verbals which are known to link the given action Performing Entity and action Receiving Entity.
        ...
        /// <returns>The Verbals which are known to link the given action Performing Entity and action Receiving Entity.</returns>
        IEnumerable<TVerbal> this[TEntity actionPerformer, Func<TEntity, TEntity, bool> performerComparer, TEntity actionReceiver, Func<TEntity, TEntity, bool> receiverComparer] { get; }
        /// <summary>
        ...
        IEnumerable<PerformerReceiverPair<TEntity, TEntity>> this[TVerbal relator] { get; }
        /// <summary>
        ...
        IEnumerable<ActionReceiverPair<TVerbal, TEntity>> this[TEntity performer] { get; }
        /// <summary>
        /// Gets the collection of Action - Receiver ActionReceiverPairs which consists of all pairings of Actions and Receivers for all received Actions the given Entity performs.
        ...
        IEnumerable<ActionReceiverPair<TVerbal, TEntity>> this[TEntity performer, Func<TEntity, TEntity, bool> performerComparer] { get; }
        /// <summary>
        /// Gets the collection of Performer - Receiver EntityPairs which consists of all pairing of Entities which are related by the given Verbal.
        ...
        /// <returns>The collection of Performer - Receiver EntityPairs which consists of all pairing of Entities which are related by the given Verbal.</returns>
        IEnumerable<PerformerReceiverPair<TEntity, TEntity>> this[TVerbal relater, Func<TVerbal, TVerbal, bool> verbalComparer] { get; }
        /// <summary>
        ...
        /// <returns>The collection of entities which are the recipients of the given action when performed by the given action Performer.</returns>
        IEnumerable<TEntity> this[TEntity actionPerformer, Func<TEntity, TEntity, bool> performerComparer, TVerbal action, Func<TVerbal, TVerbal, bool> actionComparer] { get; }
    }
}
