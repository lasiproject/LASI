...
namespace LASI.Core
{
    ...
    /// <para> Along with the other interfaces in the Syntactic Interfaces Library, the IInderectObjectTaker interface provides for cross-axial generalization over lexical types. </para>
    /// </summary>
