namespace LASI.Core
{
    ...
    public class Particle : Word, IPrepositional
    {
        ...
        public Particle(string text) : base(text) { }
        ...
        /// </summary>
        /// <param name="prepositionalObject">The ILexical construct as the object of the <see cref="Particle"/>.</param>
        ...
        /// <summary>
        /// Gets or sets the contextually extrapolated <see cref="Core.PrepositionRole"/> of the <see cref="Particle"/>.
        /// </summary>
