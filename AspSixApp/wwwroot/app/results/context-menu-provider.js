define(['jquery', 'bootstrap', 'bootstrapContextmenu'], function ($, bootstrap, bootstrapContextmenu) {
    ...
    var buildMenus = (function (verbalMenuTextToElementsMap, relationshipCssClassNameMap, contextualElementIdSelectors) {
        return function () {
                ...
                before: function (e, context) {
                    ...
                    Object.keys(menu).forEach(function (key) {
                        e.target.lexicalContextMenu[key] = menu[key].map(function (id) {
                            var idSelector = '#' + id;
                            if (!contextualElementIdSelectors
                                    .some(function (e) { return e === idSelector; })) {
