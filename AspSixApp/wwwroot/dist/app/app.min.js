...
(function(){'use strict';google.load('visualization','1.0',{'packages':['corechart']});$('#myTab a').click(function(event){event.preventDefault();$(this).tab('show');});var drawChart=function(targetElement,rowData){return function(){var dataTable=new google.visualization.DataTable({cols:[{id:'Entity',type:'string'},{id:'Weight',type:'string'}]});dataTable.addRows(rowData);var options={title:'Top Results',width:500,height:500};var chart=new google.visualization.BarChart(targetElement);chart.draw(dataTable,options);};};var charts=$('.chart-container');charts.each(function(){var element=$(this);var rowData=$.parseJSON($(element.children('span')[0]).text());google.setOnLoadCallback(drawChart(element,rowData));});}());
