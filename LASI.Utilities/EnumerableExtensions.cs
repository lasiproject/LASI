...
namespace LASI.Utilities
{
    ...
    public static class EnumerableExtensions
    {
        ...
        /// <param name="func">          An accumulator function to be invoked on each element; the element's index, determined by enumeration order, is available as the third argument.</param>
        ...
        /// <summary>
        /// Applies an accumulator function over the sequence, incorporating each elements index into the calculation.
        /// </summary>
        /// <typeparam name="TSource">The type of the elements of source.</typeparam>
        /// <param name="source">An <see cref="IEnumerable{T}"/> to aggregate over.</param>
        /// <param name="func">  An accumulator function to be invoked on each element; the element's index, determined by enumeration order, is available as the third argument.</param>
        ...
        /// <summary>
        /// Applies an accumulator function over the sequence, incorporating each element's index into the calculation. The specified seed value is used as the initial accumulator value.
        /// </summary>
        /// <typeparam name="TSource">The type of the elements of source.</typeparam>
        ...
        /// <summary>
        /// Applies an accumulator function over the sequence, incorporating each element's index into the calculation. The specified seed value is used as the initial accumulator value, and the
        ...
        /// <summary>
        /// Enumerates a sequence from right to left, applying an accumulator function which incorporating each element's index into the calculation. The specified seed value is used as the initial
        /// accumulator value.
        /// </summary>
        /// <typeparam name="TSource">The type of the elements of source.</typeparam>
        /// <typeparam name="TAccumulate">The type of the accumulator value.</typeparam>
        ...
        /// <summary>
        /// Enumerates a sequence from right to left, applying an accumulator function over a sequence, incorporating each element's index into the calculation. The specified seed value is used as the
        ...
        /// <summary>
        /// Transforms a possibly <c>null</c><see cref="IEnumerable{T}"/> into an empty enumerable. Return an empty <see cref="IEnumerable{T}"/> if <paramref name="source"/> is <c>null</c>; otherwise <paramref name="source"/>.
        /// </summary>
        ...
        /// <returns>An empty <see cref="IEnumerable{T}"/> if <paramref name="source"/> is <c>null</c>; otherwise <paramref name="source"/>.</returns>
        ...
        /// <summary>
        /// Produces the set difference of two sequences under the given projections.
        /// </summary>
        ...
        /// <param name="second">  An <see cref="IEnumerable{T}"/> to compare to the first sequence <paramref name="second"/>.</param>
        /// <param name="selector">A function to project the elements of the two sequences for comparison.</param>
        /// <returns>true if the two source sequences are of equal length and their corresponding elements compare equal under the given projection; otherwise, false.</returns>
        ...
        /// <summary>
        /// Calculates the Product of a sequence of <see cref="bool"/> values.
        /// </summary>
        /// <param name="source">The sequence of elements to test.</param>
        ...
        /// <summary>
        /// Applies an accumulator over the sequence yielding each intermediate value.
        /// </summary>
        /// <typeparam name="T">The type of the elements in the sequence.</typeparam>
        /// <param name="source">A sequence to scan.</param>
        /// <param name="func">  A function to invoke on each element in source and the accumulator value.</param>
        ...
        /// <summary>
        /// Applies an accumulator over the sequence yielding each intermediate value. The resulting sequence begins with the specified seed and ends with the final aggregate.
        /// </summary>
        /// <typeparam name="T">The type of the elements in the sequence.</typeparam>
        /// <typeparam name="TAccumulate">The type of the accumulator value.</typeparam>
        /// <param name="source">A sequence to scan.</param>
        /// <param name="seed">  A an initial seed value.</param>
        /// <param name="func">  A function to invoke on each element in source and the accumulator value.</param>
        ...
        public static IEnumerable<TResult> Zip<TFirst, TSecond, TThird, TResult>(this IEnumerable<TFirst> first,
            ...
            first.Zip(second)
                .Zip(third)
                .With((ab, c) => selector(ab.Item1, ab.Item2, c));
        ...
        /// <param name="first"> The first sequence to merge.</param>
        /// <param name="second">The second sequence to merge.</param>
        /// <returns>An <see cref="System.Collections.Generic.IEnumerable{T}"/> that contains the corresponding pairs of elements of two input sequences.</returns>
        ...
        /// <returns>A sequence which pair each element of the source sequence with its index in that sequence.</returns>
