...
namespace LASI.Utilities
{
    ...
    public static class Equality
    {
        ...
        public static IEqualityComparer<T> Create<T>(Func<T, T, bool> equals, Func<T, int> getHashCode)
        {
            ...
            return new ComparerWithCustomEqualsAndGetHashCode<T>(equals, getHashCode);
        }
        ...
        /// </code>
        /// </example>
        sealed class ComparerWithCustomEqualsAndGetHashCode<T> : EqualityComparer<T>
        {
            /// <summary>
            ...
            /// </remarks>
            public ComparerWithCustomEqualsAndGetHashCode(Func<T, T, bool> equals, Func<T, int> getHashCode)
            {
                this.equals = equals;
                this.getHashCode = getHashCode;
            }

#pragma warning disable IDE0041 // Use 'is null' Applcation triggers CS0403. Pattern sadness.
            /// <summary>
