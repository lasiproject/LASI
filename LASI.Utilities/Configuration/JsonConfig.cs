...
namespace LASI.Utilities.Configuration
{
    ...
    public class JsonConfig : LoadableConfigBase, IConfig
    {
        ...
        /// Initializes a new instance of the JsonConfig class.
        /// </summary>
        /// <param name="uri">A Uri specifying the location of the JSON document which will define the configuration object.</param>
        public JsonConfig(Uri uri) => MakeDictionary(ref data, ParseAndValidateJson(DownloadRemoteConfigData(uri)));
