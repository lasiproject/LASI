...
{
    /// <summary>
    /// Represents a tagset-to-runtime-NounPointerSymbol-mapping context which translates between a Part Of Speech
    /// Tagger'subject provided tags and their runtime NounPointerSymbol equivalents. 
    /// This class represents the tagset => runtime-NounPointerSymbol mapping for adverb occurances
    ...
    public abstract class WordTagsetMap
    {
        ...
        /// <returns>A function which creates an isntance of the run-time NounPointerSymbol associated with the textual tag.</returns>
