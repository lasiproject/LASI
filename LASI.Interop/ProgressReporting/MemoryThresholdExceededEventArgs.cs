...
namespace LASI.Interop.ProgressReporting
{
    ...
    {
        /// <summary>
        /// The amount of total machine memory available when the event was raised.
        ...
        /// <summary>
        /// The minimum memory threshold which triggered the event. This will tend to differ slightly from the value of Remaining memory.
        /// </summary>
