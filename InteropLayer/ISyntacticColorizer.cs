...
namespace LASI.Interop
{
    ...
    public interface ISyntacticColorizer<in TLexical, out TStylization> where TLexical : ILexical
    {
        /// <summary>
        /// Gets a stylization value corresponding to the syntactic nature of the indexing lexical element. Implementors should provide a default value as a fallback.
        /// </summary>
