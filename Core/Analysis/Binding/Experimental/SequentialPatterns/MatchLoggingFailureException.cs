...
namespace LASI.Core.Analysis.BinderImplementations.Experimental.SequentialPatterns
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MatchLoggingFailureException"/> class.
        /// </summary>
        public MatchLoggingFailureException() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MatchLoggingFailureException"/> class with the specified error message.
        /// </summary>
        ...
        public MatchLoggingFailureException(string message, Exception inner) : base(message, inner) { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MatchLoggingFailureException"/> class with serialized data.
        /// </summary>
        /// <param name="info">
