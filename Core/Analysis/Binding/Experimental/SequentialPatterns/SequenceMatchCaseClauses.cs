...
namespace LASI.Core.Analysis.BinderImplementations.Experimental.SequentialPatterns
{
    ...
    public partial class SequenceMatch
    {
        ...
        where T3 : class, ILexical => CheckGuard(() => Accepted = pattern.ApplyIfApplicable(SequenceFilteredByIgnoreOncePredicates));
        ...
        where T3 : class, ILexical where T4 : class, ILexical => CheckGuard(() => Accepted = pattern.ApplyIfApplicable(SequenceFilteredByIgnoreOncePredicates));
        ...
        where T5 : class, ILexical => CheckGuard(() => Accepted = pattern.ApplyIfApplicable(SequenceFilteredByIgnoreOncePredicates));
        ...
        where T6 : class, ILexical => CheckGuard(() => Accepted = pattern.ApplyIfApplicable(SequenceFilteredByIgnoreOncePredicates));
        ...
        where T7 : class, ILexical => CheckGuard(() => Accepted = pattern.ApplyIfApplicable(SequenceFilteredByIgnoreOncePredicates));
        ...
        where T8 : class, ILexical => CheckGuard(() => Accepted = pattern.ApplyIfApplicable(SequenceFilteredByIgnoreOncePredicates));
        ...
        {
            Accepted = pattern.Applicable(SequenceFilteredByIgnoreOncePredicates);
            var seq = SequenceFilteredByIgnoreOncePredicates;
