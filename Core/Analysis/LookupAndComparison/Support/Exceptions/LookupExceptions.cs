...
{
    /// <summary>
    /// The Exception to be thrown if and when an attempt is made to lookup an Adjective before the
    /// AdjectiveThesaurus has been loaded.
    /// </summary>
    [Serializable]
    public class AdjectiveDataNotLoadedException : WordDataNotLoadedException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the AdjectiveDataNotLoadedException class with its message
        ...
        /// <summary>
        /// Initializes a new instance of the AdjectiveDataNotLoadedException class with the
        /// serialized data.
        /// </summary>
        /// <param name="info">
    ...
    /// <summary>
    /// The Exception to be thrown if and when an attempt is made to lookup an Adverb before the
    /// AdverbThesaurus has been loaded.
    /// </summary>
    [Serializable]
    public class AdverbDataNotLoadedException : WordDataNotLoadedException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the AdverbDataNotLoadedException class with its message
        /// string set to message.
        /// </summary>
        /// <param name="message">
        /// A description of the error. The content of message is intended to be understood by humans.
    ...
    /// <summary>
    /// The Exception to be thrown if and when an attempt is made to lookup a word of a syntactic
    /// category which has no corresponding thesaurus.
    /// </summary>
    [Serializable]
    public sealed class NoSynonymLookupForTypeException : ArgumentException
    {
        ...
        /// The ILexical Type which was looked up
        /// </param>
    ...
    /// <summary>
    /// The Exception to be thrown if and when an attempt is made to lookup a Noun before the
    /// NounThesaurus has been loaded.
    /// </summary>
    [Serializable]
    public class NounDataNotLoadedException : WordDataNotLoadedException
    {
        /// <summary>
        /// Initializes a new instance of the NounDataNotLoadedException class with its message
        /// string set to message.
        /// </summary>
    ...
    /// <summary>
    /// The Exception to be thrown if and when an attempt is made to lookup a Verb before the
    /// VerbThesaurus has been loaded.
    /// </summary>
    [Serializable]
    public class VerbDataNotLoadedException : WordDataNotLoadedException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the VerbDataNotLoadedException class with its message
        /// string set to message.
        /// </summary>
        /// <param name="message">
        /// A description of the error. The content of message is intended to be understood by humans.
    ...
    /// <summary>
    /// The Exception to be thrown if and when an attempt is made to lookup a word before the
    /// thesaurus corresponding its type has been loaded.
    /// </summary>
    [Serializable]
    public abstract class WordDataNotLoadedException : Exception
    {
        /// <summary>
        /// Initializes a new instance of the WordDataNotLoadedException class with its message
        /// string set to message.
        /// </summary>
        /// <param name="message">
        /// A description of the error. The content of message is intended to be understood by humans.
