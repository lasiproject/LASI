namespace LASI.Core
{
    ...
    /// </summary>
    public interface IVerbal : ILexical, ISubjectTaker, IDirectObjectTaker, IInderectObjectTaker, IAdverbialModifiable, IModalityModifiable, IAttributable<IVerbal, IAdverbial>
    {
        #region Methods
