...
namespace LASI.Core
{
    ...
    public static partial class LexicalEnumerable
    {
        ...
        /// <returns> <c>true</c> if the two source sequences are of equal length and their corresponding elements compare equal according to provided Lexical comparison function; otherwise, <c>false</c>.
        /// </returns>
        ...
        /// <summary>
        /// Returns all Descriptors in the sequence.
        /// </summary>
        /// <param name="elements">The sequence of Lexicals to filter</param>
