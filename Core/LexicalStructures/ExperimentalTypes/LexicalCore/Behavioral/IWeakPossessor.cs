...
namespace LASI.Core
{
    ...
    /// <para> category because they indicate a possessive relationship between the entity(entities) which proceed(s) them and the entity(entities) which follow(s) them.  </para>
