...
namespace LASI.Core
{
    ...
    /// <para> A class which implements this interface must provide all of the behaviors of an Entity and, additionally, provide all of the behaviors of an IEnumerable collection of Entities. </para>
    /// </summary>
