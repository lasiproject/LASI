...
//    //    IMatchClause<T> With<TPattern>(Action action) where TPattern : class, ILexical;
//    //    /// <summary>
//    //    /// Appends a Match with Type expression to the current PatternMatching Expression.
//    //    /// </summary>
//    //    /// <typeparam name="TPattern">The Type to match with. If the value being matched is of this type, this Case expression will be selected and the provided action invoked.</typeparam>
...
//    //    /// <returns>The IMatchClause&lt;T, TResult&gt; describing the Match expression so far.</returns>
//    //    [System.Diagnostics.DebuggerHidden()]
//    //    IMatchClause<T> With<TPattern>(Action<TPattern> action) where TPattern : class, ILexical;
//    //    /// <summary>
...
//    //    [System.Diagnostics.DebuggerHidden()]
//    //    MatchClause<T, bool> With<TPattern>() where TPattern : class, ILexical;
...
//        /// <returns>The IPredicatedMatchClause&lt;T, TResult&gt; describing the Match expression so far. This must be followed by a single Then expression.</returns>
//        [System.Diagnostics.DebuggerHidden()]
//        IPredicatedMatchClause<T, TResult> When<TPattern>(Func<TPattern, bool> predicate) where TPattern : class, ILexical;
//        /// <summary>
//        /// Appends a Match with Type expression to the current PatternMatching Expression.
//        /// </summary>
...
//        /// <returns>The IMatchClause&lt;T, TResult&gt; describing the Match expression so far.</returns>
//        [System.Diagnostics.DebuggerHidden()]
//        IMatchClause<T, TResult> With<TPattern>(TResult result) where TPattern : class, ILexical;
//        /// <summary>
//        /// Appends a Match with Type expression to the current PatternMatching Expression.
//        /// </summary>
//        /// <typeparam name="TPattern">The Type to match with. If the value being matched is of this type, this Case expression will be selected and executed.</typeparam>
...
//        /// <returns>The IMatchClause&lt;T, TResult&gt; describing the Match expression so far.</returns>
//        [System.Diagnostics.DebuggerHidden()]
//        IMatchClause<T, TResult> With<TPattern>(Func<TResult> valueSelector) where TPattern : class, ILexical;
//        /// <summary>
//        /// Appends a Match with Type expression to the current PatternMatching Expression.
//        /// </summary>
//        /// <typeparam name="TPattern">The Type to match with. If the value being matched is of this type, this Case expression will be selected and executed.</typeparam>
...
//        /// <returns>The IMatchClause&lt;T, TResult&gt; describing the Match expression so far.</returns>
//        [System.Diagnostics.DebuggerHidden()]
//        IMatchClause<T, TResult> With<TPattern>(Func<TPattern, TResult> valueSelector) where TPattern : class, ILexical;
//        MatchClause<T> With<TPattern>() where TPattern : class, ILexical;
//    }
//    /// <summary>
...
//        [System.Diagnostics.DebuggerHidden()]
//        IMatchClause<T> Then<TPattern>(Action action) where TPattern : class, ILexical;
//        /// <summary>
//        /// Appends a Then expression to the current pattern. Then expressions work exactly like Case expressions but are only matched if they immediately follow a When expression which evaluates to true.
//        /// </summary>
//        /// <typeparam name="TPattern">The Type to match with. 
...
//        /// <returns>The IMatchClause&lt;T&gt; describing the Match expression so far.</returns>
//        [System.Diagnostics.DebuggerHidden()]
//        IMatchClause<T> Then<TPattern>(Action<TPattern> action) where TPattern : class, ILexical;
//        /// <summary>
//        /// Appends a Then expression to the current pattern. Then expressions work exactly like Case expressions but are only matched if they immediately follow a When expression which evaluates to true.
//        /// </summary> 
...
//        /// <returns>The IMatchClause&lt;T, TResult&gt; describing the Match expression so far.</returns>
//        [System.Diagnostics.DebuggerHidden()]
//        IMatchClause<T, TResult> Then<TPattern>(TResult resultValue) where TPattern : class, ILexical;
//        /// <summary>
//        /// Appends a Then expression to the current pattern. Then expressions work exactly like Case expressions but are only matched if they immediately follow a When expression which evaluates to true.
//        /// </summary> 
...
//        /// <returns>The IMatchClause&lt;T, TResult&gt; describing the Match expression so far.</returns>
//        [System.Diagnostics.DebuggerHidden()]
//        IMatchClause<T, TResult> Then<TPattern>(Func<TResult> func) where TPattern : class, ILexical;
//        /// <summary>
//        /// Appends a Then expression to the current pattern. Then expressions work exactly like Case expressions but are only matched if they immediately follow a When expression which evaluates to true.
//        /// </summary>
//        /// <typeparam name="TPattern">The Type to match with. 
...
//        /// <returns>The IMatchClause&lt;T, TResult&gt; describing the Match expression so far.</returns>
//        [System.Diagnostics.DebuggerHidden()]
//        IMatchClause<T, TResult> Then<TPattern>(Func<TPattern, TResult> func) where TPattern : class, ILexical;
//        /// <summary>
//        /// Appends a Then expression to the current pattern. Then expressions work exactly like Case expressions but are only matched if they immediately follow a When expression which evaluates to true.
//        /// </summary>
