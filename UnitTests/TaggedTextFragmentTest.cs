...
namespace LASI.UnitTests
{
    ...
    public class TaggedTextFragmentTest
    {
        ...
        public void TaggedTextFragmentConstructorTest() {
            ...
            TaggedTextFragment target = new TaggedTextFragment(text, name);
        ...
        ///</summary>
        [TestMethod()]
        public void TaggedTextFragmentConstructorTest1() {
        ...
        public void GetTextTest() {
            IEnumerable<string> text = null; // TODO: Initialize to an appropriate value
            string name = string.Empty; // TODO: Initialize to an appropriate value
            TaggedTextFragment target = new TaggedTextFragment(text, name); // TODO: Initialize to an appropriate value
