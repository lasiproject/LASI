...
namespace AlgorithmAssemblyUnitTestProject
{
    ...
    public class AggregateEntityTest
    {
        ...
        public void DirectObjectOfTest() {
            ...
            AggregateEntity target = new AggregateEntity(members);
            IVerbal expected = new VerbPhrase(new Verb[] { new Verb("eat", VerbTense.Base) }); // TODO: Initialize to an appropriate value
            IVerbal actual;
        ...
        public void SubjectOfTest() {
            ...
            AggregateEntity target = new AggregateEntity(members);
            IVerbal expected = new Verb("eat", VerbTense.Base);
            IVerbal actual;
