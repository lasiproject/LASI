...
// Source: https://raw.githubusercontent.com/aurelia/templating-router/1.0.0-rc.1.0.1/dist/aurelia-templating-router.d.ts
declare module '~aurelia-templating-router/dist/aurelia-templating-router' {
...
declare module 'aurelia-templating-router/dist/aurelia-templating-router' {
export * from '~aurelia-templating-router/dist/aurelia-templating-router';
}
