...
// Source: https://raw.githubusercontent.com/aurelia/path/1.0.0-rc.1.0.0/dist/aurelia-path.d.ts
declare module '~aurelia-path/dist/aurelia-path' {
...
declare module 'aurelia-path/dist/aurelia-path' {
export * from '~aurelia-path/dist/aurelia-path';
}
