...
// Source: https://raw.githubusercontent.com/aurelia/binding/1.0.0-rc.1.0.3/dist/aurelia-binding.d.ts
declare module '~aurelia-binding/dist/aurelia-binding' {
 ...
 */
export interface AccessScope extends Expression {
  /**
   * The property name.
   */
  name: string;
 ...
 */
export interface AccessMember extends Expression {
  /**
   * The property name.
   */
  name: string;
 ...
 */
export interface AccessKeyed extends Expression {
  /**
   * The property name.
   */
  key: Expression;
...
declare module 'aurelia-binding/dist/aurelia-binding' {
export * from '~aurelia-binding/dist/aurelia-binding';
}
