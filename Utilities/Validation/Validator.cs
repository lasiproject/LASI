...
namespace LASI.Utilities.Validation
{
    ...
    public static class Validator
    {
        ...
        /// <summary>
        /// Validates the specified <see cref="IEnumerable{T}"/> value, raising a System.ArgumentException if it is contains no elements.
        /// This implicitely materializes the sequence; see the remarks section for further details.
        /// </summary>
        /// <param name="value">The value to validate.</param>
        /// <param name="name">The name of the value to validate.</param>
        /// <remarks>
        ...
        /// </remarks>
        #region Existential Validation

        #endregion
        public static void ThrowIfEmpty<T>(IEnumerable<T> value, string name)
        {
            if (!value.Any()) { throw new ArgumentException($"Sequence cannot be empty; {name}"); }
        }
        /// <summary>
        /// Validates the specified <see cref="IEnumerable{T}"/>, raising a <see cref="ArgumentException"/> if the it is null or contains no elements. 
        /// This implicitely materializes the sequence; see the remarks section for further details.
        /// </summary>
        ...
        /// <summary>
        /// Validates that the specified value exists in the specified set of values, throwing a <see cref="ArgumentException"/> if it is not.
        /// </summary>
        /// <typeparam name="T">The type of the value to validate.</typeparam>
        /// <param name="value">The value to validate.</param>
