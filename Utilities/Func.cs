...
{
    /// <summary>
    /// Encapsulates a method that has 17 parameters and returns a value of the type specified by
    /// the TResult parameter.
    /// </summary>
    /// <typeparam name="T1">
    /// The type of the first parameter of the method that this delegate encapsulates.This type
    /// parameter is contravariant. That is, you can use either the type you specified or any type
    ...
    /// </typeparam>
    /// <typeparam name="T17">
    /// The type of the seventeenth parameter of the method that this delegate encapsulates.
    /// </typeparam>
    /// <typeparam name="TResult">
    /// The type of the return value of the method that this delegate encapsulates.This type
    /// parameter is covariant. That is, you can use either the type you specified or any type that
    /// is more derived. For more information about covariance and contravariance, see Covariance
    ...
    /// <summary>
    /// Encapsulates a method that has 18 parameters and returns a value of the type specified by
    /// the TResult parameter.
    /// </summary>
    /// <typeparam name="T1">
    /// The type of the first parameter of the method that this delegate encapsulates.This type
    ...
    /// </typeparam>
    /// <typeparam name="T18">
    /// The type of the eighteenth parameter of the method that this delegate encapsulates.
    /// </typeparam>
    /// <typeparam name="TResult">
    /// The type of the return value of the method that this delegate encapsulates.This type
    /// parameter is covariant. That is, you can use either the type you specified or any type that
    ...
    /// <summary>
    /// Encapsulates a method that has 19 parameters and returns a value of the type specified by
    /// the TResult parameter.
    /// </summary>
    /// <typeparam name="T1">
    /// The type of the first parameter of the method that this delegate encapsulates.This type
    ...
    /// </typeparam>
    /// <typeparam name="T19">
    /// The type of the nineteenth parameter of the method that this delegate encapsulates.
    /// </typeparam>
    /// <typeparam name="TResult">
    /// The type of the return value of the method that this delegate encapsulates.This type
    /// parameter is covariant. That is, you can use either the type you specified or any type that
    ...
    /// <summary>
    /// Encapsulates a method that has 20 parameters and returns a value of the type specified by
    /// the TResult parameter.
    /// </summary>
    /// <typeparam name="T1">
    /// The type of the first parameter of the method that this delegate encapsulates.This type
    ...
    /// </typeparam>
    /// <typeparam name="T20">
    /// The type of the twentieth parameter of the method that this delegate encapsulates.
    /// </typeparam>
    /// <typeparam name="TResult">
    /// The type of the return value of the method that this delegate encapsulates.This type
    /// parameter is covariant. That is, you can use either the type you specified or any type that
