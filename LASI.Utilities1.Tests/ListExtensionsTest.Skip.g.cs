...
// <copyright file="ListExtensionsTest.Skip.g.cs">Copyright ©  2013</copyright>
// <auto-generated>
...
public void Skip462()
{
    ...
    int[] ints = new int[0];
    list = new List<int>((IEnumerable<int>)ints);
    list1 = this.Skip<int>(list, int.MinValue);
    Assert.IsNotNull((object)list1);
    Assert.AreEqual<int>(0, list1.Capacity);
    Assert.AreEqual<int>(0, list1.Count);
}
